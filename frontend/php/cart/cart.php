...
<body>
   ...
   <main class="container cart-page">
      ...
      <div id="cart-empty" class="cart-state" style="display: none;">
         ...
         <a href="/shop/frontend/php/products/products.php" class="btn-outline"> مشاهده محصولات </a>
      </div>
      ...
      <div class="cart-layout">
         ...
         <aside id="cart-summary" class="cart-summary" style="display: none;">
            ...
            <div class="cart-summary-row">
               <span>جمع کل</span>
               <strong id="cart-total-price">۰ تومان</strong>
            </div>
            <a href="checkout.php" class="btn-primary"> ادامه فرآیند خرید </a>
         </aside>
